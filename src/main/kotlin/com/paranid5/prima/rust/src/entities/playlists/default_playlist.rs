use crate::{
    entities::{playlists::playlist_type::PlaylistType, tracks::default_track::DefaultTrack},
    impl_playlist_methods, impl_playlist_traits,
    utils::{extensions::track_ext::TrackExt, types::AJVM},
};
